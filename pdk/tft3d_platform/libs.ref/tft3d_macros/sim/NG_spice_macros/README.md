...
- `../../cdslib/`: Cadence-style cell/view links for real non-smoke NGspice coverage
...
Physical-only placeholders and top-level smoke checks are intentionally not
generated in this local library.
