...
- `analog_mux_2to1_diff_schematic_tran` (analog_mux_2to1_diff_nmos.spice) rows=543 dat=`results/analog_mux_2to1_diff_schematic_tran.dat`
- `analog_mux_2to1_diff_tran` (analog_mux_2to1_diff_nmos.spice) rows=543 dat=`results/analog_mux_2to1_diff_tran.dat`
- `analog_mux_bl_sl_tran` (analog_mux_bl_sl_nmos.spice) rows=546 dat=`results/analog_mux_bl_sl_tran.dat`
- `column_decoder_3to8_tran` (column_decoder_3to8_nmos.spice) rows=967 dat=`results/column_decoder_3to8_tran.dat`
...
- `nand3_x4rl_truth_tran` (peripheral_ic.spice) rows=935 dat=`results/nand3_x4rl_truth_tran.dat`
...
- `row_decoder_3to8_tran` (row_decoder_3to8_nmos.spice) rows=967 dat=`results/row_decoder_3to8_tran.dat`
