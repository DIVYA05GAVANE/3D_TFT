...
module open3dstack_user_project_wrapper (
    ...
    tran pad_s11_conn (PAD_S11, vpre);
    tran pad_s18_conn (PAD_S18, vdd_sense);
    tran pad_s19_conn (PAD_S19, vdd_inv_sense);
    tran pad_s20_conn (PAD_S20, vth_sense);
    tran pad_s21_conn (PAD_S21, vss_sense);
    tran pad_s22_conn (PAD_S22, \sense_out<0> );
    tran pad_s23_conn (PAD_S23, \sense_out<1> );
    tran pad_s24_conn (PAD_S24, \sense_out<2> );
    tran pad_s25_conn (PAD_S25, \sense_out<3> );
    tran pad_s26_conn (PAD_S26, \sense_out<4> );
    tran pad_s27_conn (PAD_S27, \sense_out<5> );
    tran pad_s28_conn (PAD_S28, \sense_out<6> );
    tran pad_s29_conn (PAD_S29, \sense_out<7> );
endmodule
